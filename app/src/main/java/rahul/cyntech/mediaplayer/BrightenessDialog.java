...
public class BrightenessDialog extends AppCompatDialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.brt_dioalog_item,null);
        builder.setView(view);
        cross = view.findViewById(R.id.brt_close);
        bright_no = view.findViewById(R.id.brt_no);
        seekBar = view.findViewById(R.id.brt_seek_bar);
